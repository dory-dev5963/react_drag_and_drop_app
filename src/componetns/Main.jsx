...
const Main = () => {
    ...
    const onDragEnd = (result) => {
        ...
        //同じカラム内でのタスクの入れ替え
        const sourColIndex = data.findIndex((e) => e.id === source.droppableId);
        const sourceCol = data[sourColIndex];

        //破壊的なメソッドを使うときは配列をコピーしておく。
        ...
        data[sourColIndex].tasks = sourceTask;
        setData(data);
        }
